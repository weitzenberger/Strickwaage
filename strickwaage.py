...
SCALES = {
    1: {  # Waagennummer als Key-Value
        "hx711": {
            "dout_pin": 0,  # Raspberry PI DOUT_PIN Nummer oder wenn "device_adress" definiert Binärcode für den PIN im Extensionboard
            "pd_sck_pin": 8,  # Raspberry PI PD_SCK_PIN Nummer
